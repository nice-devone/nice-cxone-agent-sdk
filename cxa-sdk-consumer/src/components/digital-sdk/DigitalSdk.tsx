import { Box, Button, Card, CardContent, CardHeader, InputLabel, TextField, useTheme } from "@mui/material";
import React from "react";
import { ccfAccessTokenFlowStyles, ccfGaAccessTokenFlowStyles } from "../authentication";

const DigitalSdk = ({digitalContact,handleChange,inputValue,sendReply}:{digitalContact:any,handleChange:(e:any)=>void,inputValue:any,sendReply:()=>void}) => {
