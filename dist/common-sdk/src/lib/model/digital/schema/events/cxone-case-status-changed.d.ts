...
export declare const caseStatusChangedEventSchema: import("yup").ObjectSchema<{
    data: any;
...
export declare type caseStatusChangedEvent = InferType<typeof caseStatusChangedEventSchema>;
