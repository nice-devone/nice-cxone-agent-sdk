...
class CXoneClientData {
    ...
    parse(data) {
        ...
        this.cxaFavNewGenDirectory = data === null || data === void 0 ? void 0 : data.CXAFavNewGenDirectory;
