...
/**
 * interface for CcfPlainTextEditorProps
 */
export interface CcfPlainTextEditorProps {
    /**
 ...
 * ```
 */
export declare function CcfPlainTextEditor({ editorState, onBlur, onFocus, onEditorStateChange, isEditorFocused, toolbarPlugin, onError, updatePlugin, editorRef, fileUploadPlugin, editorContainerRef, caseId, onUploadAttachment, handleEnterKey, allowSendonEnter, shouldDisplayDragDropZone, }: CcfPlainTextEditorProps): JSX.Element;
