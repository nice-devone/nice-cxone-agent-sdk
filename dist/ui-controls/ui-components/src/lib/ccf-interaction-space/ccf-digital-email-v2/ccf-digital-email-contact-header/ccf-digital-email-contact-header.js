...
import CcfDigitalEmailContactHeaderStyles from './ccf-digital-email-contact-header-styles';
...
import CcfChatFingerprintUi from '../../ccf-contact-content-header/ccf-chat-fingerprint-ui/ccf-chat-fingerprint-ui';
/**
 ...
 * ```
 */
export function CcfDigitalEmailContactHeader(props) {
    var _a, _b, _c, _d;
    ...
    const { wysiwygEnabled, isPrivate } = (_c = contactDetail === null || contactDetail === void 0 ? void 0 : contactDetail.channel) !== null && _c !== void 0 ? _c : {};
