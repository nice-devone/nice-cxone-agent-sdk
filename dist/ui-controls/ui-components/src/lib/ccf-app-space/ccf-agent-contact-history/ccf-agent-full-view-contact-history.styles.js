/**
 * Styling for fullViewContactHistory
 * @returns fullViewContactHistory CSS properties as a JSON object
 * @example fullViewContactHistory
*/
const fullViewContactHistory = (theme) => {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o;
    const styles = {
        fullViewHistoryCounterCard: {
            width: '100%',
            height: '100%',
...
export default fullViewContactHistory;
//# sourceMappingURL=ccf-agent-full-view-contact-history.styles.js.map