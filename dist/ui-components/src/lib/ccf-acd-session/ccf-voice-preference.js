 ...
 * ```
 */
export function CcfVoicePreference({ theme, isLocationFTEnabled = false, isLogoFTEnabled = false, radioButtonState, voiceConnection, showSpinner, stationOptionsChangeHandler, inputBoxState, inputNumberChangeHandler, sessionResponseState, validationError, rememberSetting, setRememberSetting, buttonState, launchBtnClickHandler, useLocationOptionHook, }) {
    var _a, _b;
