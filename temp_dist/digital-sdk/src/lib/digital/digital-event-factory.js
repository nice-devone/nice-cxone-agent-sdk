...
import { CaseStatusChangedDeltaEvent, CXoneDigitalEventType, CXoneSdkError, CXoneSdkErrorType, MessageAddedIntoCaseDeltaEvent, SenderTypingDeltaEvent } from '@nice-devone/common-sdk';
            ...
            try {
                ...
                switch (eventType) {
                    ...
                    case CXoneDigitalEventType.SENDER_TYPING_END:
                        parsedAndValidatedData = new SenderTypingDeltaEvent(eventData);
                        break;
                    default:
