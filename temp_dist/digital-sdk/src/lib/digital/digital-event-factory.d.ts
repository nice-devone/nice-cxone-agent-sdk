...
import { CaseStatusChangedDeltaEvent, MessageAddedIntoCaseDeltaEvent, SenderTypingDeltaEvent } from '@nice-devone/common-sdk';
/**
...
export declare class DigitalEventFactory {
     ...
     */
    deltaEventSubject: Subject<CaseStatusChangedDeltaEvent | MessageAddedIntoCaseDeltaEvent | SenderTypingDeltaEvent>;
    /**
