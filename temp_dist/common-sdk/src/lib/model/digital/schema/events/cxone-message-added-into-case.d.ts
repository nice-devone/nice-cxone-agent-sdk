...
export declare const messageAddedIntoCaseEventSchema: import("yup").ObjectSchema<{
    data: any;
...
export declare type messageAddedIntoCaseEvent = InferType<typeof messageAddedIntoCaseEventSchema>;
